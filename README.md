...
- **⚡ 双击 Ctrl 快速粘贴** — 在任意应用打字时双击 Ctrl,鼠标处弹出轻量选择条,选中一条历史后内容直接粘贴到光标位置,无需再按 `Ctrl+V`。类似 PowerToys 的 Win+V,但更顺手。
...
4. **双击 Ctrl** 可在鼠标位置唤起快速粘贴面板,↑↓ 选中、回车即把内容粘贴到当前光标处(可在设置中开关)。
5. 点击任意条目即可重新复制;图片条目可点击"查看大图"。
6. 通过顶部搜索框或分类标签快速筛选。
